    ...
    override fun beforeDraw(drawer: Drawer, program: Program) {
        if (client.hasNewFrame()) {
            ...
            val GL_TEXTURE_RECTANGLE = 0x84F5
                val rectBuffer = ColorBufferGL3(DriverGL3.generateResourceId(), GL_TEXTURE_RECTANGLE, name, w, h, 1.0, ColorFormat.RGBa, ColorType.UINT8, 0, BufferMultisample.Disabled, Session.root)
