...
//
//
//            var rtree = RtreePolygon2D()
//            var polygonsToFace = mutableMapOf<Polygon2D, Int>()
...
//                    rtree.findContaining(it.position).map { polygon -> polygonsToFace[polygon]!! }
//                    )
//
//                    return@listen
//                }
