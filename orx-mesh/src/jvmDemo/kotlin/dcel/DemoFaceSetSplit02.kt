...
//        program {
//
//            val grid = gridMesh(drawer.bounds, 25, 25   )
//            val dcel = grid.toDcel()
//
//            val star = regularPolygon(5, drawer.bounds.center, 100.0).contour
//            val starPolygon = star.segments.map { it.start }
//
//            dcel.faceSetSplit(dcel.allFaces().toSet(), starPolygon)
//
